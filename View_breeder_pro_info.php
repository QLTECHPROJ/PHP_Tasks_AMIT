...
<head>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.1/js/all.min.js"
        crossorigin="anonymous"></script>
    <title>View Breeder info | Padigree</title>
...
<body>
    ...
    <div class="site-main">
        ...
        <section class="view_Breeder_sec">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-6 col-md-6 col-sm-12 viewbr_form_bx">
                        <div class="viewbreeder_form">
                            <form>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 ">
                        <div class="breeder_savefrm pt-3 lg-pb-5 pb-2 text-center">
                            <a href="Add_breeder.html">Edit</a>
                        </div>
                    </div>
                </div>
            </div>
